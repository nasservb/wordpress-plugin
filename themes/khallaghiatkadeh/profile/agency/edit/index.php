			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4" style="    padding-right: 2px;">
						<input type="text" name="input_father_name" class="form-control" id="father_name" placeholder="نام پدر" value="<?php echo $father_name  ?>" />
					</div>
				</div>
			</div>				 
			<div class="form-group">
				<div class="row">
					<div class="col-md-4" style="padding-left:2px;text-align:right">
						<input type="checkbox" style="width:40px;float:right" name="married" class="form-control" id="married"      <?php echo ( $married == 1 ? 'checked' : '' );  ?>  />متاهل هستم
					</div>
					<div class="col-md-4" >
...
<script>
	...
	else 
	{
		...
		update_user_meta( $id, 'married'			,($_POST['married']== 'on'? 1 : 0 ) ); 
