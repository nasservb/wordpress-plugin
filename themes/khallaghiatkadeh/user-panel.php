...
<!---machine picture area--->
	<section class="sec-course "  >
       <div class="content-bg container"> 
			<div class="cntainer ">
				<div class="row">
					<div class="col-sm-2 col-md-3 panel pull-left">
						<div class="pull-right menu-frame">
							...
							<div class="menu-box" style="min-height: 200px;">
								<ul >
									...
									<li class="menu-message <?php echo ($dir=='request'? 'active' : '') ?>"><a href="?dir=message">درخواست ها</a></li>
					...
					<div class="col-sm-8 pull-right">
						<?php 
							include 'profile/student/'. $dir . '/' . $page . '.php';
						?>
					</div>
				</div>	
			</div>
